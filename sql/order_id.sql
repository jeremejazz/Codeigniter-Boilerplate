...
CREATE TABLE `order_id` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='For Order ID Generation';

/*Data for the table `order_id` */

insert  into `order_id`(`id`,`content`) values (000000000001,''),(000000000002,'');
